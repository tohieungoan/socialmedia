...
class Myfriend extends StatefulWidget {
  ...
  @override
  _Myfriend createState() => _Myfriend();
}

class _Myfriend extends State<Myfriend> {
                            ...
                            slivers: [
                              SliverPadding(
                                ...
                                sliver: SliverToBoxAdapter(
                                  child: Mylistfriend(ListUsers: friendsList),
                                ),
                              ),
                            ],
                          );
  ...
  Future<List<User>> _getFriendsList() async {
    final getlistfriend = Getlistfriend();
    try {
